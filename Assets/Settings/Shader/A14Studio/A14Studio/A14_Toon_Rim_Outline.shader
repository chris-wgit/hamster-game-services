...
Shader "A14_Toon_Rim_Outline"
{
	Properties
	{
		...
		[TCP2ColorNoAlpha] _RimColor ("Rim Color", Color) = (1,1,1,0.5)
		_RimMin ("Rim Min", Range(0,2)) = 2
		_RimMax ("Rim Max", Range(0,2)) = 1
		[TCP2Separator]
		
		[TCP2HeaderHelp(Outline)]
		_OutlineWidth ("Width", Range(0.1,6)) = 1
...
/* TCP_DATA u config(unity:"2020.3.16f1";ver:"2.7.3";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2020_1","OUTLINE","OUTLINE_URP_FEATURE","OUTLINE_CLIP_SPACE","OUTLINE_BEHIND_STENCIL","SHADOW_COLOR_MAIN_DIR","RIM_OUTLINE","AUTO_TRANSPARENT_BLENDING","OUTLINE_OPAQUE","DISABLE_ADDITIONAL_LIGHTS","RIM_SHADER_FEATURE","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Outline"];shaderProperties:list[,sp(name:"Main Color";imps:list[imp_mp_color(def:RGBA(1, 1, 1, 1);hdr:False;cc:4;chan:"RGBA";prop:"_Color";md:"";gbv:False;custom:False;refs:"";guid:"53cd13d9-1a3b-45cf-8fca-3ef2cc6b1c3d";op:Multiply;lbl:"Color";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,,,,,,sp(name:"Rim Color";imps:list[imp_mp_color(def:RGBA(1, 1, 1, 0.5);hdr:False;cc:3;chan:"RGB";prop:"_RimColor";md:"";gbv:False;custom:False;refs:"";guid:"65bb84e7-593b-4f51-865b-ec50e760bd3f";op:Multiply;lbl:"Rim Color";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,sp(name:"Rim Min";imps:list[imp_mp_range(def:2;min:0;max:2;prop:"_RimMin";md:"";gbv:False;custom:False;refs:"";guid:"d82ece8a-8d2d-4f18-8099-248565493a89";op:Multiply;lbl:"Rim Min";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,,sp(name:"Outline Width";imps:list[imp_mp_range(def:1;min:0.1;max:6;prop:"_OutlineWidth";md:"";gbv:False;custom:False;refs:"";guid:"ac2cb98b-7d22-4a17-b457-c1cee720ef04";op:Multiply;lbl:"Width";gpu_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH dd60e7e1caf1795da05a16c8e8d841fe */
